        ...
        <header className="mb-14 md:mb-20">
          <div className="flex flex-col-reverse items-center gap-10 md:flex-row md:gap-14">
            ...
            <div className="flex shrink-0 flex-col items-center gap-1.5">
              <img src="https://perupowerhouse.com/wp-content/uploads/2021/05/cropped-POWERH-BLANC.png" alt="PowerHouse" loading="lazy" decoding="async" className="w-10 object-contain md:w-12" />
        ...
        <div className="grid grid-cols-1 overflow-hidden rounded-2xl border border-white/10 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <DayColumn shortLabel={t("agenda.thursday_short")} label={t("agenda.thursday_full")}>
            <div className="flex h-full w-full flex-col justify-center gap-2">
              ...
              <span className="text-center text-[10px] font-medium uppercase tracking-[0.18em] text-white/60">{t("agenda.thu_piura_l3")}</span>
            </div>
          </DayColumn>
            ...
            <div className="flex h-full w-full flex-col items-center justify-center gap-5">
              ...
              <div className="flex w-full max-w-[14rem] flex-col items-center gap-8">
                <div className="flex w-full flex-col items-center gap-1 rounded-2xl border border-white/10 bg-[#2563EB] px-5 py-4 text-center shadow-[0_10px_30px_rgba(37,99,235,0.25)]">
                  ...
                  <span className="block w-full text-sm font-bold uppercase tracking-[0.18em] text-white/80">{t("agenda.sun_service1_l2")}</span>
                  <span className="mt-1 block w-full text-sm font-bold uppercase tracking-[0.2em] text-white">9AM</span>
                </div>
                <div className="flex w-full flex-col items-center gap-1 rounded-2xl border border-white/10 bg-[#2563EB] px-5 py-4 text-center shadow-[0_10px_30px_rgba(37,99,235,0.25)]">
                  <span className="block w-full text-sm font-bold uppercase tracking-[0.18em] text-white">{t("agenda.sun_service2_l1")}</span>
                  <span className="block w-full text-sm font-bold uppercase tracking-[0.18em] text-white/80">{t("agenda.sun_service2_l2")}</span>
